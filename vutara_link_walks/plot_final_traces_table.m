function plot_final_traces_table(data)
figure();
set(gcf,'name','Final Traces Table','NumberTitle','off','color','w','units','normalized','position',[0.2 0.1 0.7 0.5],'menubar','none','toolbar','figure')

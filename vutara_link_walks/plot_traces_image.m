function plot_traces_image(data,ref_data)

figure();
set(gcf,'name','Traces & image','NumberTitle','off','color','w','units','normalized','position',[0.3 0.2 0.4 0.5],'menubar','none','toolbar','figure')
